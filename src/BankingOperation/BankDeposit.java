...
public class BankDeposit {
    ...
    public void depositIntoSaving() throws SQLException, ClassNotFoundException {
        ...
        s2.setInt(1,id);
        s2.setString(2,"deposit");
        s2.setFloat(3,deposit);
    ...
    public void depositintoPAyAccount() throws ClassNotFoundException, SQLException {
        Class.forName("com.mysql.cj.jdbc.Driver");
        EstablishConnection();
        System.out.println("Enter your  Account Number");
        long AccountNo= sc.nextLong();
